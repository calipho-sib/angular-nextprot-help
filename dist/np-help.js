...
angular.module('npHelp').run(['$templateCache', function ($templateCache) {
	$templateCache.put('html/np-help.doc.html', '<div ng-controller="DocCtrl"> <markdown markdown-article="{{article}}">Loading ...</markdown> <div class="clearfix gh-page-improve gh-page-{{article}}"> <hr/> <button class="btn btn-primary pull-right" edit-markdown="{{article}}">Improve this page</button> </div> </div> ');
